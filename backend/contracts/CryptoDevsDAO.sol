...
interface ICryptoDevsNFT {
    ...
    /// @return Returns the number of NFTs owned    function balanceOf(address owner) external view returns (uint256);
...
contract CryptoDevsDAO is Ownable {
  ...
  IFakeNFTMarketplace immutable nftMarketplace;
  ICryptoDevsNFT immutable cryptoDevsNFT;
